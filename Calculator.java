...
public class Calculator implements ActionListener {
...

    {
        ...
        sinButton.setBackground(Color.GRAY);

        cosButton.setBackground(Color.GRAY);

        tanButton.setBackground(Color.GRAY);

        inverseButton.setBackground(Color.GRAY);

        factButton.setBackground(Color.GRAY);

        piButton.setBackground(Color.GRAY);

        tanButton.setBackground(Color.GRAY);

        powButton.setBackground(Color.GRAY);

        lnButton.setBackground(Color.GRAY);

        sqrtButton.setBackground(Color.GRAY);

        cbrtButton.setBackground(Color.GRAY);

        eButton.setBackground(Color.GRAY);

        dotButton.setBackground(Color.LIGHT_GRAY);

        Color c3 = new Color(255, 0, 0); // red
